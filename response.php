...
$r=(int)$_POST['r'];
if (empty($_POST['x1'])&empty($_POST['x2'])&empty($_POST['x3'])&empty($_POST['x4'])&empty($_POST['x6'])&(strlen($_POST['x5']) == 0)&empty($_POST['x7'])&empty($_POST['x8'])&empty($_POST['x9'])) die ("Вы не выбрали переменную X");
